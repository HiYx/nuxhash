...
DEFAULT_SETTINGS = {
    'nicehash': {
        'wallet': '39UJr2EqYYHeUshpNeyGw21naQMPgwC6Xw',
        'workername': 'nuxhash',
        'region': 'hk',
        'api_organization': '4310de78-7b62-4994-8447-9d1a8f97ab9f',
        'api_key': '39UJr2EqYYHeUshpNeyGw21naQMPgwC6Xw',
        'api_secret': '1790b160-efcb-4752-be1a-7f944c687cc1f70adae1-c9c4-4a34-80c6-2be7083fe8f1'
        },
    'switching': {
        'interval': 60,
        'threshold': 0.1
